...
namespace KModkit
{
    ...
    public abstract class WorkBase
    {
        ...
        /// </value>
        public bool AllowSimultaneousActive { get; protected set; }

        /// <value>
        /// Counts the number of threads currently active within this class, and all of its overloads.
        /// </value>
        public static uint ThreadsActive { get; protected set; }
        ...
        protected IEnumerator WaitForOtherThreads()
        {
            return new WaitWhile(() => _maximumThreadsActive <= ThreadsActive);
        }
        ...
        protected IEnumerator WaitForOwnThread()
        {
