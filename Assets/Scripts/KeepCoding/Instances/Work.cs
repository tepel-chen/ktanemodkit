...
namespace KModkit
{
    ...
    public sealed class Work : WorkBase
    {
            ...
            : base(allowSimultaneousActive, maximumThreadsActive)
        {
            Thread = new Thread(() =>
            {
                work.NullCheck("The variable work cannot be null.")();
                IsRunning = false;
            });
        }
    ...
    public sealed class Work<T> : WorkBase
    {
            ...
            : base(allowSimultaneousActive, maximumThreadsActive)
        {
            Thread = new Thread(() =>
            {
                Result = work.NullCheck("The variable work cannot be null.")();
                IsRunning = false;
            });
        }
    ...
    public sealed class Work<T, TResult> : WorkBase
    {
        ...
        public IEnumerator Start(T arg)
        {
            ...
            Thread = new Thread(() =>
            {
                Result = _work.NullCheck("The variable _work cannot be null.")(arg);
                IsRunning = false;
            });
    ...
    public sealed class Work<T1, T2, TResult> : WorkBase
    {
        ...
        public IEnumerator Start(T1 arg1, T2 arg2)
        {
            ...
            Thread = new Thread(() =>
            {
                Result = _work.NullCheck("The variable _work cannot be null.")(arg1, arg2);
                IsRunning = false;
            });
    ...
    public sealed class Work<T1, T2, T3, TResult> : WorkBase
    {
        ...
        public IEnumerator Start(T1 arg1, T2 arg2, T3 arg3)
        {
            ...
            Thread = new Thread(() =>
            {
                Result = _work.NullCheck("The variable _work cannot be null.")(arg1, arg2, arg3);
                IsRunning = false;
            });
    ...
    public sealed class Work<T1, T2, T3, T4, TResult> : WorkBase
    {
        ...
        public IEnumerator Start(T1 arg1, T2 arg2, T3 arg3, T4 arg4)
        {
            ...
            Thread = new Thread(() =>
            {
                Result = _work.NullCheck("The variable _work cannot be null.")(arg1, arg2, arg3, arg4);
                IsRunning = false;
            });
