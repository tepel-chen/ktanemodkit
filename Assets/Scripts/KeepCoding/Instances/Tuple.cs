...
namespace KModkit
{
    ...
    public class Tuple<T> : Tuple, IEquatable<Tuple<T>>
    {
        ...
        {
            get { return i == 0 ? Item1 : base[i]; }
            set
            {
                if (i == 0)
                    Item1 = Cast<object, T>(ref value, i);
                else
                    base[i] = value;
            }
        }
        ...
        {
            return 592959197 + EqualityComparer<T>.Default.GetHashCode(Item1);
        }
        ...
        public static bool operator ==(Tuple<T> tupleA, Tuple<T> tupleB)
        {
            return tupleA == null ? tupleB == null : tupleA.Equals(tupleB);
        }
    ...
    public class Tuple<T1, T2> : Tuple<T1>, IEquatable<Tuple<T1, T2>>
    {
        ...
        public new object this[byte i]
        {
            get { return i == 1 ? Item2 : base[i]; }
            set
            {
                if (i == 1)
                    Item2 = Cast<object, T2>(ref value, i);
                else
                    base[i] = value;
            }
        }
        ...
        public override string ToString()
        {
            return string.Join(" ", ToArray.ConvertAll(o => o.ToString()));
        }
        ...
        public static bool operator ==(Tuple<T1, T2> tupleA, Tuple<T1, T2> tupleB)
        {
            return tupleA == null ? tupleB == null : tupleA.Equals(tupleB);
        }
    ...
    public class Tuple<T1, T2, T3> : Tuple<T1, T2>, IEquatable<Tuple<T1, T2, T3>>
    {
        ...
        public new object this[byte i]
        {
            get { return i == 2 ? Item3 : base[i]; }
            set
            {
                if (i == 2)
                    Item3 = Cast<object, T3>(ref value, i);
                else
                    base[i] = value;
            }
        }
        ...
        /// <param name="tupleB">The right-hand side comparison.</param>
        /// <returns>True if <paramref name="tupleA.ToArray"/> and all of <paramref name="tupleB.ToArray"/> are equal in sequence.</returns>
        public static bool operator ==(Tuple<T1, T2, T3> tupleA, Tuple<T1, T2, T3> tupleB)
        {
            return tupleA == null ? tupleB == null : tupleA.Equals(tupleB);
        }
    ...
    public class Tuple<T1, T2, T3, T4> : Tuple<T1, T2, T3>, IEquatable<Tuple<T1, T2, T3, T4>>
    {
        ...
        public new object this[byte i]
        {
            get { return i == 3 ? Item4 : base[i]; }
            set
            {
                if (i == 3)
                    Item4 = Cast<object, T4>(ref value, i);
                else
                    base[i] = value;
            }
        }
        ...
        /// <param name="tupleB">The right-hand side comparison.</param>
        /// <returns>True if <paramref name="tupleA.ToArray"/> and all of <paramref name="tupleB.ToArray"/> are equal in sequence.</returns>
        public static bool operator ==(Tuple<T1, T2, T3, T4> tupleA, Tuple<T1, T2, T3, T4> tupleB)
        {
            return tupleA == null ? tupleB == null : tupleA.Equals(tupleB);
        }
