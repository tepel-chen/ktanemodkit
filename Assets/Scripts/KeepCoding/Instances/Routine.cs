...
namespace KModkit
{
    ...
    public sealed class Routine : RoutineBase
    {
        ...
        public Routine(Func<IEnumerator> enumerator, MonoBehaviour monoBehaviour) : base(monoBehaviour)
        {
    ...
    public sealed class Routine<T> : RoutineBase
    {
        ...
        /// <param name="enumerator">The enumerator to call when initiated.</param>
        /// <param name="monoBehaviour">The MonoBehaviour to reference when calling the method.</param>
        public Routine(Func<T, IEnumerator> enumerator, MonoBehaviour monoBehaviour) : base(monoBehaviour)
        {
            _enumerator = enumerator;
        }
    ...
    public sealed class Routine<T1, T2> : RoutineBase
    {
        ...
        /// <param name="enumerator">The enumerator to call when initiated.</param>
        /// <param name="monoBehaviour">The MonoBehaviour to reference when calling the method.</param>
        public Routine(Func<T1, T2, IEnumerator> enumerator, MonoBehaviour monoBehaviour) : base(monoBehaviour)
        {
            _enumerator = enumerator;
        }
    ...
    public sealed class Routine<T1, T2, T3> : RoutineBase
    {
        ...
        /// <param name="enumerator">The enumerator to call when initiated.</param>
        /// <param name="monoBehaviour">The MonoBehaviour to reference when calling the method.</param>
        public Routine(Func<T1, T2, T3, IEnumerator> enumerator, MonoBehaviour monoBehaviour) : base(monoBehaviour)
        {
            _enumerator = enumerator;
        }
    ...
    public sealed class Routine<T1, T2, T3, T4> : RoutineBase
    {
        ...
        /// <param name="enumerator">The enumerator to call when initiated.</param>
        /// <param name="monoBehaviour">The MonoBehaviour to reference when calling the method.</param>
        public Routine(Func<T1, T2, T3, T4, IEnumerator> enumerator, MonoBehaviour monoBehaviour) : base(monoBehaviour)
        {
            _enumerator = enumerator;
        }
