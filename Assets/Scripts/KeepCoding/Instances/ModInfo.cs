...
namespace KModkit
{
    ...
    public sealed class ModInfo
    {
        ...
        public static ModInfo Deserialize(string path)
        {
            return JsonConvert.DeserializeObject<ModInfo>(File.ReadAllText(path.NullCheck("A \"null\" path cannot be searched.")));
        }
    }
}
