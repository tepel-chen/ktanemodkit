...
namespace KModkit
{
    ...
    public static class TypeHelper
    {
        ...
        {
            return colors.NullCheck("You cannot iterate over a null array.").Any(c => c.Equals(color));
        }
        ...
        public static Color IntertwineColor(this Renderer renderer, Color colorA, Color colorB,
            float concentrationOfB = 0.5f)
        {
            return renderer.material.color = colorA.IntertwineColor(colorB, concentrationOfB);
        }
        ...
        /// <param name="a">The alpha component; opacity.</param>
        /// <returns>A new instance of the <paramref name="color"/>, with the arguments replacing the values.</returns>
        public static Color Replace(this Color color, float? r = null, float? g = null, float? b = null,
            float? a = null)
        {
            return new Color(
                r ?? color.r,
        ...
        public static Color32 HexToColor(this string hex)
        {
            ...
            return new Color32(byte.Parse(hex.Substring(0, 2), NumberStyles.HexNumber), byte.Parse(hex.Substring(2, 2), NumberStyles.HexNumber), byte.Parse(hex.Substring(4, 2), NumberStyles.HexNumber), (byte)(hex.Length < 8 ? 255 : byte.Parse(hex.Substring(6, 2), NumberStyles.HexNumber)));
        }
        ...
        /// <param name="concentrationOfB">The bias towards either color, between 0-1. 0.5 blends both colors equally.</param>
        /// <returns>The resulting color that the <paramref name="renderer"/> becomes.</returns>
        public static Color32 IntertwineColor(this Renderer renderer, Color32 colorA, Color32 colorB,
            float concentrationOfB = 0.5f)
        {
            return renderer.material.color = colorA.IntertwineColor(colorB, concentrationOfB);
        }
        ...
        /// <param name="a">The alpha component; opacity.</param>
        /// <returns>A new instance of the <paramref name="color"/>, with the arguments replacing the values.</returns>
        public static Color32 Replace(this Color32 color, float? r = null, float? g = null, float? b = null,
            float? a = null)
        {
            return new Color32(
        ...
        /// <param name="a">The alpha component; opacity.</param>
        /// <returns>A new instance of the <paramref name="color"/>, with the arguments replacing the values.</returns>
        public static Color32 Replace(this Color32 color, byte? r = null, byte? g = null, byte? b = null,
            byte? a = null)
        {
            return new Color32(
                r ?? color.r,
        ...
        public static Routine ToRoutine(this MonoBehaviour monoBehaviour, Func<IEnumerator> func)
        {
            return new Routine(func, monoBehaviour);
        }
        ...
        public static Routine<T> ToRoutine<T>(this MonoBehaviour monoBehaviour, Func<T, IEnumerator> func)
        {
            return new Routine<T>(func, monoBehaviour);
        }
        ...
        public static Routine<T1, T2> ToRoutine<T1, T2>(this MonoBehaviour monoBehaviour,
            Func<T1, T2, IEnumerator> func)
        {
            return new Routine<T1, T2>(func, monoBehaviour);
        }
        ...
        public static Routine<T1, T2, T3> ToRoutine<T1, T2, T3>(this MonoBehaviour monoBehaviour,
            Func<T1, T2, T3, IEnumerator> func)
        {
            return new Routine<T1, T2, T3>(func, monoBehaviour);
        }
        ...
        public static Routine<T1, T2, T3, T4> ToRoutine<T1, T2, T3, T4>(this MonoBehaviour monoBehaviour,
            Func<T1, T2, T3, T4, IEnumerator> func)
        {
            return new Routine<T1, T2, T3, T4>(func, monoBehaviour);
        }
        ...
        public static Tuple<T> ToTuple<T>(this T item)
        {
        ...
        public static Tuple<T1, T2> ToTuple<T1, T2>(this T1 item1, T2 item2)
        {
        ...
        public static Tuple<T1, T2, T3> ToTuple<T1, T2, T3>(this T1 item1, T2 item2, T3 item3)
        {
        ...
        public static Tuple<T1, T2, T3, T4> ToTuple<T1, T2, T3, T4>(this T1 item1, T2 item2, T3 item3, T4 item4)
        {
        ...
        /// <param name="w">The w value.</param>
        /// <returns>A new instance of <paramref name="vector"/>, with the arguments replacing the values.</returns>
        public static Vector4 Replace(ref Vector4 vector, float? x = null, float? y = null, float? z = null,
            float? w = null)
        {
            return vector = new Vector4(
                x ?? vector.x,
        ...
        /// <param name="w">The w value.</param>
        /// <returns>A new instance of <paramref name="vector"/>, with the arguments replacing the values.</returns>
        public static Vector4 Replace(this Vector4 vector, float? x = null, float? y = null, float? z = null,
            float? w = null)
        {
            return new Vector4(
                x ?? vector.x,
        ...
        public static Work ToWork(this uint maximumThreadsActive, Action action, bool allowSimultaneousActive = false)
        {
            return new Work(action, allowSimultaneousActive, maximumThreadsActive);
        }
        ...
        public static Work<T> ToWork<T>(this uint maximumThreadsActive, Func<T> func,
            bool allowSimultaneousActive = false)
        {
            return new Work<T>(func, allowSimultaneousActive, maximumThreadsActive);
        }
        ...
        public static Work<T, TResult> ToWork<T, TResult>(this uint maximumThreadsActive, Func<T, TResult> func,
            bool allowSimultaneousActive = false)
        {
            return new Work<T, TResult>(func, allowSimultaneousActive, maximumThreadsActive);
        }
        ...
        public static Work<T1, T2, TResult> ToWork<T1, T2, TResult>(this uint maximumThreadsActive,
            Func<T1, T2, TResult> func, bool allowSimultaneousActive = false)
        {
            return new Work<T1, T2, TResult>(func, allowSimultaneousActive, maximumThreadsActive);
        }
        ...
        public static Work<T1, T2, T3, TResult> ToWork<T1, T2, T3, TResult>(this uint maximumThreadsActive,
            Func<T1, T2, T3, TResult> func, bool allowSimultaneousActive = false)
        {
            return new Work<T1, T2, T3, TResult>(func, allowSimultaneousActive, maximumThreadsActive);
        }
        ...
        public static Work<T1, T2, T3, T4, TResult> ToWork<T1, T2, T3, T4, TResult>(this uint maximumThreadsActive,
            Func<T1, T2, T3, T4, TResult> func, bool allowSimultaneousActive = false)
        {
            return new Work<T1, T2, T3, T4, TResult>(func, allowSimultaneousActive, maximumThreadsActive);
        }
    }
}
